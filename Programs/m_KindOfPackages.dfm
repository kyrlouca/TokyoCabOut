object M_KIndOfPackagesFRM: TM_KIndOfPackagesFRM
  Left = 483
  Top = 710
  ...
  object TableSQL: TIBCQuery
    SQLInsert.Strings = (
      'INSERT INTO AUX_KIND_OF_PACKAGES'
      '  (IS_DEFAULT, DESCRIPTION, KEY)'
      'VALUES'
      '  (:IS_DEFAULT, :DESCRIPTION, :KEY)')
    SQLDelete.Strings = (
      'DELETE FROM AUX_KIND_OF_PACKAGES'
      'WHERE'
      '  KEY = :Old_KEY')
    SQLUpdate.Strings = (
      'UPDATE AUX_KIND_OF_PACKAGES'
      'SET'
      ...
      '  KEY = :Old_KEY')
    SQLRefresh.Strings = (
      'SELECT IS_DEFAULT, DESCRIPTION, KEY FROM AUX_KIND_OF_PACKAGES'
      'WHERE'
      '  KEY = :KEY')
    SQLLock.Strings = (
      'SELECT NULL FROM AUX_KIND_OF_PACKAGES'
      'WHERE'
      'KEY = :Old_KEY'
      'FOR UPDATE WITH LOCK')
    SQLRecCount.Strings = (
      'SELECT COUNT(*) FROM ('
      'SELECT 1 AS C  FROM AUX_KIND_OF_PACKAGES'
      ''
      ') q')
