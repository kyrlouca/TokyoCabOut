...
type
  TL_FlightOutListFRM = class(TForm)
    ...
    procedure FlightOutGRDTitleButtonClick(Sender: TObject; AFieldName: string);
  private
...
uses MainForm, H_flightOut, H_scanAirwaybill,
  H_ScanAirwaybillNew, G_kyriacosTypes;
...
procedure TL_FlightOutListFRM.ScanBTNClick(Sender: TObject);
Var
...
procedure TL_FlightOutListFRM.FlightOutGRDTitleButtonClick(Sender: TObject;
  AFieldName: string);
var
...
begin
        ...
        HawbDS:=TIBCQuery(FLightOutGRD.DataSource.DataSet);
