object M_certificatesFRM: TM_certificatesFRM
  Left = 285
  Top = 102
  ClientHeight = 621
  ClientWidth = 775
    ...
    object Panel5: TPanel
      ...
      object GroupBox1: TGroupBox
        ...
        object FlightOutGRD: TwwDBGrid
          ...
          Selected.Strings = (
            'CODE'#9'10'#9'CODE'
            'DESCRIPTION'#9'41'#9'DESCRIPTION'
  ...
  object ItinerarySQL: TIBCQuery
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        '  CODE = :CODE, DESCRIPTION = :DESCRIPTION, IS_DEFAULT = :IS_DEF' +
        'AULT'
      'WHERE'
      '  CODE = :Old_CODE')
    SQLRefresh.Strings = (
      'SELECT CODE, DESCRIPTION, IS_DEFAULT FROM CERTIFICATE_GROUP'
      'WHERE'
      '  CODE = :CODE')
    SQLLock.Strings = (
    ...
    Left = 80
    Top = 25
    object ItinerarySQLCODE: TStringField
      DisplayWidth = 10
      FieldName = 'CODE'
      Required = True
      Size = 10
    end
    object ItinerarySQLDESCRIPTION: TStringField
      DisplayWidth = 41
      FieldName = 'DESCRIPTION'
      FixedChar = True
      Size = 60
    end
    object ItinerarySQLIS_DEFAULT: TStringField
  ...
  object ItineraryCountrySQL: TIBCQuery
    ...
    KeyGenerator = 'CERTIFICATE_ITEM_GEN'
    SQLInsert.Strings = (
      'INSERT INTO CERTIFICATE_ITEM'
      
        '  (SERIAL_NUMBER, CERT_CODE, FK_CERTIFICATE_GROUP, CERT_TYPE, CE' +
        'RT_VALUE, FIELD_FOR_VALUE, TABLE_FOR_VALUE, DESCRIPTION)'
      'VALUES'
      
        '  (:SERIAL_NUMBER, :CERT_CODE, :FK_CERTIFICATE_GROUP, :CERT_TYPE' +
        ', :CERT_VALUE, :FIELD_FOR_VALUE, :TABLE_FOR_VALUE, :DESCRIPTION)')
    SQLDelete.Strings = (
      'DELETE FROM CERTIFICATE_ITEM'
      'WHERE'
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        '  SERIAL_NUMBER = :SERIAL_NUMBER, CERT_CODE = :CERT_CODE, FK_CER' +
        'TIFICATE_GROUP = :FK_CERTIFICATE_GROUP, CERT_TYPE = :CERT_TYPE, ' +
        'CERT_VALUE = :CERT_VALUE, FIELD_FOR_VALUE = :FIELD_FOR_VALUE, TA' +
        'BLE_FOR_VALUE = :TABLE_FOR_VALUE, DESCRIPTION = :DESCRIPTION'
      'WHERE'
      '  SERIAL_NUMBER = :Old_SERIAL_NUMBER')
    SQLRefresh.Strings = (
      
        'SELECT SERIAL_NUMBER, CERT_CODE, FK_CERTIFICATE_GROUP, CERT_TYPE' +
        ', CERT_VALUE, FIELD_FOR_VALUE, TABLE_FOR_VALUE, DESCRIPTION FROM' +
        ' CERTIFICATE_ITEM'
      'WHERE'
      '  SERIAL_NUMBER = :SERIAL_NUMBER')
    SQLLock.Strings = (
      'SELECT NULL FROM CERTIFICATE_ITEM'
      'WHERE'
      'SERIAL_NUMBER = :Old_SERIAL_NUMBER'
      'FOR UPDATE WITH LOCK')
    SQLRecCount.Strings = (
      'SELECT COUNT(*) FROM ('
      'SELECT 1 AS C  FROM CERTIFICATE_ITEM'
      ''
      ') q')
    Connection = MainFormFRM.CabOutData
    Transaction = MainFormFRM.UsedForReadOnlyTrans
    ...
    object ItineraryCountrySQLTABLE_FOR_VALUE: TStringField
      DisplayLabel = 'Table'
      DisplayWidth = 22
    ...
    object ItineraryCountrySQLFIELD_FOR_VALUE: TStringField
      DisplayLabel = 'Field'
      DisplayWidth = 30
