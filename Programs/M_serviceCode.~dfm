object M_ServiceCodesFRM: TM_ServiceCodesFRM
  Left = 435
  Top = 238
  Width = 764
  Height = 678
  ...
  object ServiceCodeSQL: TIBCQuery
    ...
    SQLUpdate.Strings = (
      ...
      '  SERIAL_NUMBER = :Old_SERIAL_NUMBER')
    SQLRefresh.Strings = (
      'SELECT SERIAL_NUMBER, CODE, DESCRIPTION FROM SERVICE_CODE'
      'WHERE'
      '  SERIAL_NUMBER = :SERIAL_NUMBER')
    SQLLock.Strings = (
      'SELECT NULL FROM SERVICE_CODE'
      'WHERE'
      'SERIAL_NUMBER = :Old_SERIAL_NUMBER'
      'FOR UPDATE WITH LOCK')
    SQLRecCount.Strings = (
      'SELECT COUNT(*) FROM ('
      'SELECT 1 AS C  FROM SERVICE_CODE'
      ''
      ') q')
    ...
    SQL.Strings = (
      ...
      '  service_code')
    Active = True
    AfterInsert = ServiceCodeSQLAfterInsert
    Left = 537
    Top = 117
