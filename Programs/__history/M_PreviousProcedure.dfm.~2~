object M_PreviousProcedureFRM: TM_PreviousProcedureFRM
  Left = 483
  Top = 710
  ...
  object TableSQL: TIBCQuery
    SQLInsert.Strings = (
      'INSERT INTO AUX_PREVIOUS_PROCEDURE'
      '  (IS_DEFAULT, DESCRIPTION, KEY)'
      'VALUES'
      '  (:IS_DEFAULT, :DESCRIPTION, :KEY)')
    SQLDelete.Strings = (
      'DELETE FROM AUX_PREVIOUS_PROCEDURE'
      'WHERE'
      '  KEY = :Old_KEY')
    SQLUpdate.Strings = (
      'UPDATE AUX_PREVIOUS_PROCEDURE'
      'SET'
      ...
      '  KEY = :Old_KEY')
    SQLRefresh.Strings = (
      'SELECT IS_DEFAULT, DESCRIPTION, KEY FROM AUX_PREVIOUS_PROCEDURE'
      'WHERE'
      '  KEY = :KEY')
    SQLLock.Strings = (
      'SELECT NULL FROM AUX_PREVIOUS_PROCEDURE'
      'WHERE'
      'KEY = :Old_KEY'
      'FOR UPDATE WITH LOCK')
    SQLRecCount.Strings = (
      'SELECT COUNT(*) FROM ('
      'SELECT 1 AS C  FROM AUX_PREVIOUS_PROCEDURE'
      ''
      ') q')
