object H_FlightAirItemFRM: TH_FlightAirItemFRM
  Left = 365
  Top = 153
  Caption = '--'
  ClientHeight = 641
  ...
  object Panel1: TPanel
    ...
    object Label4: TLabel
      ...
      Align = alClient
      Alignment = taCenter
      Caption = 'Flight Airwaybill Item'
      Layout = tlCenter
      ExplicitWidth = 279
      ExplicitHeight = 32
    end
  ...
  object Panel3: TPanel
    ...
    object RzPanel5: TRzPanel
      ...
      object GroupBox2: TGroupBox
        ...
        object Select2: TwwDBLookupCombo
          Left = 202
          Top = 17
          Width = 121
          Height = 24
          DropDownAlignment = taLeftJustify
          Selected.Strings = (
            'CERT_CODE'#9'10'#9'CERT_CODE'#9#9
            'DESCRIPTION'#9'30'#9'DESCRIPTION'#9#9)
          DataField = 'CERT_CODE'
          LookupTable = SelectCertSQL
          LookupField = 'CERT_CODE'
          TabOrder = 2
          AutoDropDown = False
          ShowButton = True
          PreciseEditRegion = False
          AllowClearKey = False
          OnCloseUp = Select2CloseUp
        end
        object SelGroupFLD: TwwDBLookupCombo
          Left = 16
          Top = 20
          Width = 129
          Height = 24
  ...
  object TableSQL: TIBCQuery
    ...
    SQL.Strings = (
      ...
      '*'
      'FROM'
      'FLIGHT_AIRWAYBILL_ITEM where serial_number = :SerialNumber')
    ...
    object TableSQLSEQUENCE: TIntegerField
      FieldName = 'SEQUENCE'
    end
    object TableSQLWEIGHT: TFloatField
      FieldName = 'WEIGHT'
    end
    object TableSQLPIECES: TIntegerField
      FieldName = 'PIECES'
    end
    ...
    object TableSQLCURRENCY_RATE: TFloatField
      FieldName = 'CURRENCY_RATE'
    end
    object TableSQLCURRENCY: TStringField
      FieldName = 'CURRENCY'
      FixedChar = True
      Size = 3
    end
    ...
    object TableSQLCOUNTRY_OF_ORIGIN: TStringField
  ...
  object SelectCertSQL: TIBCQuery
    SQLInsert.Strings = (
    ...
    Transaction = ReadTrans
    SQL.Strings = (
      'Select * from  certificate_item order by  cert_code')
    DetailFields = 'FK_FLIGHT_AIRWAYBILL_ITEM'
    Left = 496
    Top = 98
    object SelectCertSQLCERT_CODE: TStringField
      DisplayWidth = 10
      FieldName = 'CERT_CODE'
      Required = True
      Size = 10
    end
    object SelectCertSQLDESCRIPTION: TStringField
      DisplayWidth = 30
      FieldName = 'DESCRIPTION'
      FixedChar = True
      Size = 30
    end
    object SelectCertSQLSERIAL_NUMBER: TIntegerField
      DisplayWidth = 10
      FieldName = 'SERIAL_NUMBER'
      Required = True
      Visible = False
    end
    object SelectCertSQLFK_CERTIFICATE_GROUP: TStringField
      DisplayWidth = 10
      FieldName = 'FK_CERTIFICATE_GROUP'
      Visible = False
      Size = 10
    end
    object SelectCertSQLCERT_TYPE: TStringField
      DisplayWidth = 2
      FieldName = 'CERT_TYPE'
      Visible = False
      FixedChar = True
    ...
    object SelectCertSQLCERT_VALUE: TStringField
      DisplayWidth = 10
      FieldName = 'CERT_VALUE'
      Visible = False
      Size = 10
    end
    object SelectCertSQLFIELD_FOR_VALUE: TStringField
      DisplayWidth = 30
    ...
    object SelectCertSQLTABLE_FOR_VALUE: TStringField
      DisplayWidth = 30
