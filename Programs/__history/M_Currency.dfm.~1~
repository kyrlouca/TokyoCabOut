object M_CurrencyFRM: TM_CurrencyFRM
  ...
  object CurrencySQL: TIBCQuery
    SQLInsert.Strings = (
      ...
      '  (DESCRIPTION, CURRENCY_CODE, COUNTRY_CODE, XML_CURRENCY)'
      'VALUES'
      '  (:DESCRIPTION, :CURRENCY_CODE, :COUNTRY_CODE, :XML_CURRENCY)')
    SQLDelete.Strings = (
      'DELETE FROM CURRENCY'
      'WHERE'
      '  CURRENCY_CODE = :Old_CURRENCY_CODE')
    SQLUpdate.Strings = (
      'UPDATE CURRENCY'
      'SET'
      
        '  DESCRIPTION = :DESCRIPTION, CURRENCY_CODE = :CURRENCY_CODE, CO' +
        'UNTRY_CODE = :COUNTRY_CODE, XML_CURRENCY = :XML_CURRENCY'
      'WHERE'
      '  CURRENCY_CODE = :Old_CURRENCY_CODE')
    SQLRefresh.Strings = (
      
        'SELECT DESCRIPTION, CURRENCY_CODE, COUNTRY_CODE, XML_CURRENCY FR' +
        'OM CURRENCY'
      'WHERE'
      '  CURRENCY_CODE = :CURRENCY_CODE')
    SQLLock.Strings = (
      'SELECT NULL FROM CURRENCY'
      'WHERE'
      'CURRENCY_CODE = :Old_CURRENCY_CODE'
      'FOR UPDATE WITH LOCK')
    SQLRecCount.Strings = (
      'SELECT COUNT(*) FROM ('
      'SELECT 1 AS C  FROM CURRENCY'
      ''
      ') q')
    ...
    SQL.Strings = (
      ...
      ' Currency')
    Active = True
    AfterInsert = CurrencySQLAfterInsert
    Left = 537
    Top = 117
