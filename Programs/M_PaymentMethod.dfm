object M_PaymentMEthodFRM: TM_PaymentMEthodFRM
  Left = 483
  Top = 710
  ...
  object TableSQL: TIBCQuery
    SQLInsert.Strings = (
      ...
      '  (IS_DEFAULT, DESCRIPTION, THE_KEY, XML_CODE)'
      'VALUES'
      '  (:IS_DEFAULT, :DESCRIPTION, :THE_KEY, :XML_CODE)')
    SQLDelete.Strings = (
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        '  IS_DEFAULT = :IS_DEFAULT, DESCRIPTION = :DESCRIPTION, THE_KEY ' +
        '= :THE_KEY, XML_CODE = :XML_CODE'
      'WHERE'
      '  THE_KEY = :Old_THE_KEY')
    SQLRefresh.Strings = (
      
        'SELECT IS_DEFAULT, DESCRIPTION, THE_KEY, XML_CODE FROM PAYMENT_M' +
        'ETHOD'
      'WHERE'
      '  THE_KEY = :THE_KEY')
    SQLLock.Strings = (
      'SELECT NULL FROM PAYMENT_METHOD'
      'WHERE'
      'THE_KEY = :Old_THE_KEY'
      'FOR UPDATE WITH LOCK')
    SQLRecCount.Strings = (
      'SELECT COUNT(*) FROM ('
      'SELECT 1 AS C  FROM PAYMENT_METHOD'
      ''
      ') q')
    ...
    Left = 329
    Top = 237
    object TableSQLTHE_KEY: TStringField
      DisplayLabel = 'Code'
      DisplayWidth = 10
      FieldName = 'THE_KEY'
      Required = True
