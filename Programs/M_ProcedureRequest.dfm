object M_ProcedureRequestFRM: TM_ProcedureRequestFRM
  Left = 483
  Top = 710
  ...
  object TableSQL: TIBCQuery
    SQLInsert.Strings = (
      'INSERT INTO AUX_PROCEDURE_REQUEST'
      '  (IS_DEFAULT, DESCRIPTION, KEY)'
      'VALUES'
      '  (:IS_DEFAULT, :DESCRIPTION, :KEY)')
    SQLDelete.Strings = (
      'DELETE FROM AUX_PROCEDURE_REQUEST'
      'WHERE'
      '  KEY = :Old_KEY')
    SQLUpdate.Strings = (
      'UPDATE AUX_PROCEDURE_REQUEST'
      'SET'
      ...
      '  KEY = :Old_KEY')
    SQLRefresh.Strings = (
      'SELECT IS_DEFAULT, DESCRIPTION, KEY FROM AUX_PROCEDURE_REQUEST'
      'WHERE'
      '  KEY = :KEY')
    SQLLock.Strings = (
      'SELECT NULL FROM AUX_PROCEDURE_REQUEST'
      'WHERE'
      'KEY = :Old_KEY'
      'FOR UPDATE WITH LOCK')
    SQLRecCount.Strings = (
      'SELECT COUNT(*) FROM ('
      'SELECT 1 AS C  FROM AUX_PROCEDURE_REQUEST'
      ''
      ') q')
