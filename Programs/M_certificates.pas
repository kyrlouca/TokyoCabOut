...
type
  TM_certificatesFRM = class(TForm)
    ...
    ItineraryCountrySQLCERT_CODE: TStringField;
    ...
    ItineraryCountrySQLFIELD_FOR_VALUE: TStringField;
    ItineraryCountrySQLTABLE_FOR_VALUE: TStringField;
    ...
    procedure ItineraryCountrySQLNewRecord(DataSet: TDataSet);
  private
...
procedure TM_certificatesFRM.ItineraryCountrySQLNewRecord(DataSet: TDataSet);
begin
if ItinerarySQL.State in [dsEdit, dsInsert] then
  ItinerarySQL.Post;
end;
