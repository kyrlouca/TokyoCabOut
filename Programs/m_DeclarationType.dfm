object M_declarationTypeFRM: TM_declarationTypeFRM
  Left = 483
  Top = 710
  ...
  object TableSQL: TIBCQuery
    SQLInsert.Strings = (
      'INSERT INTO AUX_DECLARATION_TYPE'
      '  (IS_DEFAULT, DESCRIPTION, KEY)'
      'VALUES'
      '  (:IS_DEFAULT, :DESCRIPTION, :KEY)')
    SQLDelete.Strings = (
      'DELETE FROM AUX_DECLARATION_TYPE'
      'WHERE'
      '  KEY = :Old_KEY')
    SQLUpdate.Strings = (
      'UPDATE AUX_DECLARATION_TYPE'
      'SET'
      ...
      '  KEY = :Old_KEY')
    SQLRefresh.Strings = (
      'SELECT IS_DEFAULT, DESCRIPTION, KEY FROM AUX_DECLARATION_TYPE'
      'WHERE'
      '  KEY = :KEY')
    SQLLock.Strings = (
      'SELECT NULL FROM AUX_DECLARATION_TYPE'
      'WHERE'
      'KEY = :Old_KEY'
      'FOR UPDATE WITH LOCK')
    SQLRecCount.Strings = (
      'SELECT COUNT(*) FROM ('
      'SELECT 1 AS C  FROM AUX_DECLARATION_TYPE'
      ''
      ') q')
