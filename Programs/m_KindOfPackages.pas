...
uses
  ...
  RzDBChk;
type
  TM_KIndOfPackagesFRM = class(TForm)
    Panel1: TPanel;
    Panel4: TPanel;
    Panel2: TPanel;
    Nav1: TwwDBNavigator;
...
var
  M_KIndOfPackagesFRM: TM_KIndOfPackagesFRM;
...
procedure TM_KIndOfPackagesFRM.FormActivate(Sender: TObject);
begin
TableSQL.close;
TableSQL.Open;
...
procedure TM_KIndOfPackagesFRM.BitBtn2Click(Sender: TObject);
begin
close;
end;

procedure TM_KIndOfPackagesFRM.TableSQLBeforeEdit(
  DataSet: TDataSet);
begin
...
procedure TM_KIndOfPackagesFRM.TableSRCStateChange(Sender: TObject);
begin
...
procedure TM_KIndOfPackagesFRM.FormKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TM_KIndOfPackagesFRM.TableSQLAfterInsert(DataSet: TDataSet);
begin
   NameFLD.SetFocus;
