...
type
  ...
  TMainFormFRM = class(TForm)
    ...
    KindOfPackages1: TMenuItem;
    N1: TMenuItem;
    N2: TMenuItem;
    PaymentMethods1: TMenuItem;
    ...
    procedure KindOfPackages1Click(Sender: TObject);
    procedure PaymentMethods1Click(Sender: TObject);
  private
...
procedure TMainFormFRM.PaymentMethods1Click(Sender: TObject);
begin
M_PaymentMEthodFRM.ShowModal();
end;
...
procedure TMainFormFRM.KindOfPackages1Click(Sender: TObject);
begin
M_KIndOfPackagesFRM.ShowModal;
end;
