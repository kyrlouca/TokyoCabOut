  ...
  object Panel3: TPanel
    ...
    object Panel5: TPanel
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Height = 299
        Selected.Strings = (
          'SERIAL_NUMBER'#9'4'#9'SN'
          'MTD_KEY'#9'35'#9'Mawb'#9'F'
          'TRANSPORT_DOC'#9'15'#9'TDoc'
          'SHIPMENTS'#9'11'#9'Shimpents'
      ...
      object Panel2: TPanel
        ...
        object SearchMawbFLD: TwwDBEdit
          Left = 140
          Top = 28
          Width = 149
          Height = 24
    ...
    object Panel6: TPanel
      ...
      object Panel9: TPanel
        ...
        object AirGRD: TwwDBGrid
          ...
          Height = 556
          Selected.Strings = (
            'SERIAL_NUMBER'#9'5'#9'SN'
            'SEQUENCE_NUMBER'#9'3'#9'Seq'
            'HAWB_ID'#9'10'#9'Hawb'
            'ITEMS_COUNT'#9'10'#9'Items'
            'SHIPMENT_ORIGIN_COUNTRY'#9'8'#9'Origin~Country'
            'PIECES'#9'8'#9'Pieces'
            'PIECES_S'#9'7'#9'Pieces/s'
            'WEIGHT'#9'10'#9'Weight'
            'DESCRIPTION'#9'38'#9'Description'
            'SENDER_NAME'#9'35'#9'SENDER_NAME'
            'SENDER_ADDRESS'#9'35'#9'SENDER_ADDRESS'
            'SENDER_POST_CODE'#9'9'#9'SENDER_POST_CODE'
            'SENDER_CITY'#9'35'#9'SENDER_CITY'
            'SENDER_COUNTRY_CODE'#9'2'#9'SENDER_COUNTRY_CODE'
            'CONSIGNEE_NAME'#9'35'#9'CONSIGNEE_NAME'
            'CONSIGNEE_ADDRESS'#9'35'#9'CONSIGNEE_ADDRESS'
            'CONSIGNEE_POST_CODE'#9'9'#9'CONSIGNEE_POST_CODE'
            'CONSIGNEE_CITY'#9'35'#9'CONSIGNEE_CITY'
            'CONSIGNEE_COUNTRY_CODE'#9'2'#9'CONSIGNEE_COUNTRY_CODE'
            'FK_ITINERARY_SERIAL'#9'10'#9'FK_ITINERARY_SERIAL'
