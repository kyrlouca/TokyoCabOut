...
//**
//**
//** CreateMsgHeader515  -- just the header - has the totals
...
//    function TBLCreateXMLNode(XMLDoc:IXMLDocument;ElementFather:IXMLNode;ElementName:String;ElementValue:String; Dataset: TDataset; FieldName:String; ElementType: TNodeType =ntElement):IXMLNode;
  ...
  function CreateNodeOuter( Const FlightOutSerial:Integer; XmlRandom:Integer;criteria:TCriteriaParams;const Fdoc: IXMLDocument):Integer;
  function CreateMsgHeader515( Const FlightOutSerial:Integer;XmlRandom:Integer;criteria:TCriteriaParams; const Fdoc: IXMLDocument;FatherNode:IXMLNode):IXMLNode;
...
begin
  ...
  if (XmlRandom =0 ) then begin
    ...
    exit;
     ...
     /////////////////////////////////////////////////////////////////////////
       result := CreateNodeOuter(FlightOutSerial,xmlRandom,Criteria,Fdoc);
     /////////////////////////////////////////////////////////////////////////
...
function TX_CreateMultiHighXmlFRM.CreateNodeOuter(const FlightOutSerial: Integer; XmlRandom: Integer; criteria: TCriteriaParams; const Fdoc: IXMLDocument): Integer;
var
  qr,Flightqr, FirstAirQr: TksQuery;
  DeclarantQr: TksQuery;
  FatherNode, x1Node, x2Node: IXMLNode;
  DhlSerial: Integer;
...
//      Clipboard.AsText:=FirstAirQR.FinalSQL;
    ...
    FatherNode := FDoc.AddChild('CC515A');
...
//     CreateXMLNodeNew(FDoc,FatherNode,'RecipientIdentifCodeQualifier','CY',ntText);
    ...
    CreateXMLNodeNew(FDoc, FatherNode, 'MessageType', 'CC515A', ntText);
     ...
     //***Header***************************************
    CreateMsgHeader515(FlightOutSerial, XmlRandom, criteria, FDoc, FatherNode);
     //*************************************************
     //Exporter/Consignor
    if CheckSameSender(FlightOutSerial, XmlRandom) then begin
      CreateConsignorAddressNode(FlightOutSerial, 0, XmlRandom, 'Msg515Exporter', Fdoc, FatherNode);
    end;
     //*************************************************
     //Consignee
    if CheckSameConsignee(FlightOutSerial, XmlRandom) then begin
      CreateConsigneeAddressNode(FlightOutSerial, 0, XmlRandom, 'Msg515ConsigneeTrader', Fdoc, FatherNode);
    end;
...
function TX_CreateMultiHighXmlFRM.CreateMsgHeader515( Const FlightOutSerial:Integer;XmlRandom:Integer;criteria:TCriteriaParams; const Fdoc: IXMLDocument;FatherNode:IXMLNode):IXMLNode;
var
...
//          TblCreateXMLNode(FDoc,x2Node,'DocumentReference','',qrCert,'cert_value',ntText);
      ...
      CreateXMLNodeNew(FDoc, x2node, 'TARICSecondAdditionalCode', '0000', ntText);
       ...
       //Consignor
      if (not CheckSameSender(FlightSerial, XmlRandom)) then begin
        CreateConsignorAddressNode(FlightSerial, CurrentAirSerial, XmlRandom, 'Msg615ConsignorTrader', Fdoc, HEaderNode);
      end;

       //Consignee
      if (not CheckSameConsignee(FlightSerial, XmlRandom)) then begin
        CreateConsigneeAddressNode(FlightSerial, CurrentAirSerial, XmlRandom, 'Msg515ConsigneeTrader', Fdoc, HEaderNode);
      end;
...
function TX_CreateMultiHighXmlFRM.CreateCustomerAddressNode( Const CustomerSerial:Integer; NodeName:string; const Fdoc: IXMLDocument;FatherNode:IXMLNode):IXMLNode;
var
  HeaderNode,x2Node:IXMLNode;
  str:string   ;
  dString:string;
...
function TX_CreateMultiHighXmlFRM.CreateConsignorAddressNode( Const FlightSerial, AirSerial, xmlRandom :Integer; NodeName:string; const Fdoc: IXMLDocument;FatherNode:IXMLNode):IXMLNode;
var
  HeaderNode,x2Node:IXMLNode;
  strFirst:string;
  strair:string;
...
function TX_CreateMultiHighXmlFRM.CreateConsigneeAddressNode( Const FlightSerial, AirSerial, xmlRandom :Integer; NodeName:string; const Fdoc: IXMLDocument;FatherNode:IXMLNode):IXMLNode;
var
  HeaderNode,x2Node:IXMLNode;
  strFirst:string;
  strair:string;
