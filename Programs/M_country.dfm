object M_countryFRM: TM_countryFRM
  ...
  object CountryIBSQL: TIBCQuery
    UpdatingTable = 'COUNTRY'
    ...
    Left = 80
    Top = 25
    object CountryIBSQLSERIAL_NUMBER: TIntegerField
      DisplayLabel = 'S/N'
      DisplayWidth = 6
      FieldName = 'SERIAL_NUMBER'
    end
    object CountryIBSQLCODE_2: TStringField
      DisplayLabel = 'Code'
      DisplayWidth = 6
      FieldName = 'CODE_2'
      FixedChar = True
    ...
    object CountryIBSQLNAME: TStringField
      DisplayLabel = 'Name'
      DisplayWidth = 60
      FieldName = 'NAME'
      FixedChar = True
