...
With FAirwaybillParamSQL do begin
        first;
        While not Eof do begin
                delete;
        end;
...
With ParamGroupITemSQL do begin
        first;
        While not Eof do begin
                FAirwayBillParamSQL.Insert;
                FAirwayBillParamSQL.FieldByName('INFO_TYPE').Value:=FieldBYName('INFO_TYPE').AsString;
                FAirwayBillParamSQL.FieldByName('INFO_VALUE').Value:=FieldBYName('INFO_VALUE').AsString;
