object ReadFileFRM: TReadFileFRM
  Left = 160
  Top = 75
  Width = 1436
  Height = 938
  ...
  object Panel3: TPanel
    ...
    Align = alClient
    TabOrder = 2
    object ReadFileBTN: TfcShapeBtn
      Left = 32
      Top = 96
      Width = 185
      Height = 73
    ...
    object HawbGRD: TwwDBGrid
      ...
      Font.Style = []
      KeyOptions = []
      Options = [dgEditing, dgAlwaysShowEditor, dgIndicator, dgTabs, dgRowSelect, dgAlwaysShowSelection, dgConfirmDelete, dgCancelOnExit, dgWordWrap]
      ParentFont = False
      ReadOnly = True
      TabOrder = 4
  ...
  object SenderInvoiceSQL: TIBCQuery
    ...
    SQL.Strings = (
        ...
        'select * from Sender_Invoice si where si.fk_hawb_serial= :HawbSe' +
        'rial and si.invoice_serial= :invoiceSerial')
    Left = 152
    Top = 360
    ParamData = <
      item
  ...
  object FindCurrencySQL: TIBCQuery
    SQL.Strings = (
      'Select * from Currency where xml_currency= :XMLCode')
    ReadOnly = True
    Left = 736
    Top = 434
    ParamData = <
  ...
  object ExchangeRateSQL: TIBCQuery
    SQL.Strings = (
        ...
        'Select * from Exchange_rate where FK_CURRENCY_CODE= :CurrencyCod' +
        'e')
    ReadOnly = True
    Left = 1120
    Top = 386
  ...
  object SearchHawbSQL: TIBCQuery
    Transaction = ReadTrans
    SQL.Strings = (
      'Select'
      '  ha.serial_number,'
      ...
      'where '
      '  ha.Hab_id = :Habid'
      '  and ma.reference_number= ha.fk_mawb_refer_number')
    ReadOnly = True
    Left = 72
    Top = 562
    ParamData = <
    ...
    object SearchHawbSQLSERIAL_NUMBER: TIntegerField
      FieldName = 'SERIAL_NUMBER'
      Required = True
    end
    object SearchHawbSQLHAB_ID: TStringField
      FieldName = 'HAB_ID'
      Required = True
      Size = 10
    end
    object SearchHawbSQLFK_MAWB_REFER_NUMBER: TIntegerField
      FieldName = 'FK_MAWB_REFER_NUMBER'
      Required = True
    end
    object SearchHawbSQLREFERENCE_NUMBER: TIntegerField
      FieldName = 'REFERENCE_NUMBER'
      ReadOnly = True
      Required = True
    end
    object SearchHawbSQLMAWB_ID: TStringField
      FieldName = 'MAWB_ID'
      ReadOnly = True
      Size = 15
    end
  ...
  object PartialHawbSQL: TIBCQuery
    ...
    object PartialHawbSQLFK_MAWB_ID_ORIGINAL: TStringField
    ...
    object PartialHawbSQLFK_MAWB_ID_ARRIVED: TStringField
  ...
  object SearchFlightOUtSQL: TIBCQuery
    SQLInsert.Strings = (
    ...
    SQLUpdate.Strings = (
      'UPDATE FLIGHT_OUT'
      'SET'
      '  SERIAL_NUMBER = :SERIAL_NUMBER, MAWB = :MAWB'
      'WHERE'
      '  SERIAL_NUMBER = :Old_SERIAL_NUMBER')
    SQLRefresh.Strings = (
      'SELECT SERIAL_NUMBER, MAWB FROM FLIGHT_OUT'
      'WHERE'
    ...
    object SearchFlightOUtSQLSERIAL_NUMBER: TIntegerField
      FieldName = 'SERIAL_NUMBER'
      Required = True
    end
    object SearchFlightOUtSQLMAWB: TStringField
      FieldName = 'MAWB'
      Required = True
      FixedChar = True
      Size = 15
  ...
  object IBCQuery1: TIBCQuery
    SQL.Strings = (
      'Select * from Country where xml_country= :XMLCode')
    ReadOnly = True
    Left = 392
    Top = 482
    ParamData = <
  ...
  object HawbSQL: TIBCQuery
    ...
    SQLInsert.Strings = (
      'INSERT INTO AIRWAYBILL'
        ...
        'MBER, CONSIGNEE_PREFERRED_NAME, SENDER_PREFERRED_NAME)'
      'VALUES'
        ...
        ', :CONSIGNEE_EMAIL, :SERVICE_CODE, :ACCOUNT_NUMBER, :CONSIGNEE_P' +
        'REFERRED_NAME, :SENDER_PREFERRED_NAME)')
    SQLDelete.Strings = (
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        ', ACCOUNT_NUMBER = :ACCOUNT_NUMBER, CONSIGNEE_PREFERRED_NAME = :' +
        'CONSIGNEE_PREFERRED_NAME, SENDER_PREFERRED_NAME = :SENDER_PREFER' +
        'RED_NAME'
      'WHERE'
      '  SERIAL_NUMBER = :Old_SERIAL_NUMBER')
    SQLRefresh.Strings = (
        ...
        'T_NUMBER, CONSIGNEE_PREFERRED_NAME, SENDER_PREFERRED_NAME FROM A' +
        'IRWAYBILL'
      'WHERE'
      '  SERIAL_NUMBER = :SERIAL_NUMBER')
    SQLLock.Strings = (
    ...
    object HawbSQLSEQUENCE_NUMBER: TIntegerField
      FieldName = 'SEQUENCE_NUMBER'
    end
    object HawbSQLHAWB_ID: TStringField
      FieldName = 'HAWB_ID'
      Size = 10
    end
    object HawbSQLSHIPMENT_ORIGIN_AREA: TStringField
      FieldName = 'SHIPMENT_ORIGIN_AREA'
      Size = 10
    end
    object HawbSQLSHIPMENT_ORIGIN_COUNTRY: TStringField
      FieldName = 'SHIPMENT_ORIGIN_COUNTRY'
      FixedChar = True
      Size = 5
    end
    object HawbSQLPIECES: TIntegerField
      FieldName = 'PIECES'
    end
    ...
    object HawbSQLFK_DOCUMENT_MASTER_SERIAL: TIntegerField
      FieldName = 'FK_DOCUMENT_MASTER_SERIAL'
    end
    object HawbSQLFK_MOVEMENT_SERIAL: TIntegerField
      FieldName = 'FK_MOVEMENT_SERIAL'
    end
    object HawbSQLPIECES_S: TStringField
      FieldName = 'PIECES_S'
      FixedChar = True
      Size = 15
    end
    ...
    object HawbSQLSENDER_ADDRESS: TStringField
    ...
    object HawbSQLSENDER_COUNTRY_CODE: TStringField
      FieldName = 'SENDER_COUNTRY_CODE'
      FixedChar = True
      Size = 2
    end
    object HawbSQLCONSIGNEE_NAME: TStringField
      FieldName = 'CONSIGNEE_NAME'
      FixedChar = True
      Size = 35
    end
    object HawbSQLCONSIGNEE_ADDRESS: TStringField
      FieldName = 'CONSIGNEE_ADDRESS'
      FixedChar = True
      Size = 35
    end
    object HawbSQLCONSIGNEE_POST_CODE: TStringField
      FieldName = 'CONSIGNEE_POST_CODE'
      FixedChar = True
      Size = 9
    end
    object HawbSQLCONSIGNEE_CITY: TStringField
      FieldName = 'CONSIGNEE_CITY'
      FixedChar = True
      Size = 35
    end
    object HawbSQLCONSIGNEE_COUNTRY_CODE: TStringField
      FieldName = 'CONSIGNEE_COUNTRY_CODE'
      FixedChar = True
      Size = 2
    end
    object HawbSQLFK_ITINERARY_SERIAL: TIntegerField
      FieldName = 'FK_ITINERARY_SERIAL'
    end
    object HawbSQLPACKAGES_COUNT: TIntegerField
      FieldName = 'PACKAGES_COUNT'
    end
    object HawbSQLITEMS_COUNT: TIntegerField
      FieldName = 'ITEMS_COUNT'
    end
    object HawbSQLPAYMENT_METHOD: TStringField
      FieldName = 'PAYMENT_METHOD'
      FixedChar = True
      Size = 2
    end
    object HawbSQLIS_HIGH: TStringField
      FieldName = 'IS_HIGH'
      FixedChar = True
      Size = 1
    end
    ...
    object HawbSQLCURRENCY_RATE: TFloatField
    ...
    object HawbSQLCONSIGNEE_ADDRESS_1: TStringField
      FieldName = 'CONSIGNEE_ADDRESS_1'
      FixedChar = True
      Size = 35
    end
    object HawbSQLCONSIGNEE_ADDRESS_2: TStringField
      FieldName = 'CONSIGNEE_ADDRESS_2'
      FixedChar = True
      Size = 35
    end
    object HawbSQLCONSIGNEE_ADDRESS_3: TStringField
      FieldName = 'CONSIGNEE_ADDRESS_3'
      FixedChar = True
      Size = 35
    end
    object HawbSQLSENDER_DEVICE_TYPE: TStringField
      FieldName = 'SENDER_DEVICE_TYPE'
      FixedChar = True
      Size = 9
    end
    object HawbSQLSENDER_DEVICE_DETAILS: TStringField
      FieldName = 'SENDER_DEVICE_DETAILS'
      FixedChar = True
      Size = 35
    end
    object HawbSQLCONSIGNEE_DEVICE_TYPE: TStringField
      FieldName = 'CONSIGNEE_DEVICE_TYPE'
      FixedChar = True
      Size = 9
    end
    object HawbSQLCONSIGNEE_DEVICE_DETAILS: TStringField
      FieldName = 'CONSIGNEE_DEVICE_DETAILS'
      FixedChar = True
      Size = 35
    end
    object HawbSQLVALUE_TYPE: TStringField
      FieldName = 'VALUE_TYPE'
      FixedChar = True
      Size = 1
    end
    object HawbSQLINCOTERMS: TStringField
      FieldName = 'INCOTERMS'
      FixedChar = True
      Size = 9
    end
    object HawbSQLIS_SCANNED: TStringField
      FieldName = 'IS_SCANNED'
      FixedChar = True
      Size = 1
    end
    object HawbSQLSENDER_EMAIL: TStringField
      FieldName = 'SENDER_EMAIL'
      FixedChar = True
      Size = 60
    end
    object HawbSQLCONSIGNEE_EMAIL: TStringField
      FieldName = 'CONSIGNEE_EMAIL'
      FixedChar = True
      Size = 60
    end
    object HawbSQLSERVICE_CODE: TStringField
      FieldName = 'SERVICE_CODE'
      Size = 10
    end
    object HawbSQLACCOUNT_NUMBER: TStringField
      FieldName = 'ACCOUNT_NUMBER'
      FixedChar = True
      Size = 15
    end
    object HawbSQLCONSIGNEE_PREFERRED_NAME: TStringField
      FieldName = 'CONSIGNEE_PREFERRED_NAME'
      FixedChar = True
      Size = 35
    end
    object HawbSQLSENDER_PREFERRED_NAME: TStringField
      FieldName = 'SENDER_PREFERRED_NAME'
      FixedChar = True
      Size = 35
    end
  end
  object FindCustomerSQL: TIBCQuery
    SQLInsert.Strings = (
    ...
    SQL.Strings = (
        ...
        'Select code, Name, Company_or_person from CUstomer where code= :' +
        'CustomerCode')
    ReadOnly = True
    Left = 496
    Top = 346
    ...
    object FindCustomerSQLCODE: TIntegerField
      FieldName = 'CODE'
      Required = True
    end
    object FindCustomerSQLNAME: TStringField
      FieldName = 'NAME'
      Required = True
      Size = 80
    end
    object FindCustomerSQLCOMPANY_OR_PERSON: TStringField
      FieldName = 'COMPANY_OR_PERSON'
      Size = 1
    end
  end
  object ReadLowHawbSQL: TIBCQuery
    KeyFields = 'serial_number'
    ...
    SQLInsert.Strings = (
      'INSERT INTO HAWB'
        ...
        'IS_MEDIUM, MEDIUM_VAT_RATE, IS_CHARGED_DELIVERY)'
      'VALUES'
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        'IUM_VAT_RATE, IS_CHARGED_DELIVERY = :IS_CHARGED_DELIVERY'
      'WHERE'
      '  SERIAL_NUMBER = :Old_SERIAL_NUMBER')
    SQLRefresh.Strings = (
        ...
        '_C, IS_MEDIUM, MEDIUM_VAT_RATE, IS_CHARGED_DELIVERY FROM HAWB'
      'WHERE'
      '  SERIAL_NUMBER = :SERIAL_NUMBER')
    SQLLock.Strings = (
    ...
    SQL.Strings = (
        ...
        'select * from Hawb where fk_mawb_refer_number=:MawbSerial and IS' +
        '_MEDIUM<>'#39'Y'#39' AND HIGH_VALUE <>'#39'Y'#39)
    Left = 1120
    Top = 16
    ParamData = <
      item
  ...
  object FindHawbLowDeletedSQL: TIBCQuery
    KeyFields = 'serial_number'
    ...
    SQL.Strings = (
        ...
        'select * from Hawb_low_deleted where SErial_number= :SerialNumbe' +
        'r')
    Left = 1104
    Top = 96
    ParamData = <
    ...
    object FindHawbLowDeletedSQLHAB_ID: TStringField
      FieldName = 'HAB_ID'
      Required = True
      Size = 10
    end
    object FindHawbLowDeletedSQLSERIAL_NUMBER: TIntegerField
      FieldName = 'SERIAL_NUMBER'
    end
    object FindHawbLowDeletedSQLFK_MAWB_REFER_NUMBER: TIntegerField
      FieldName = 'FK_MAWB_REFER_NUMBER'
      Required = True
    end
    object FindHawbLowDeletedSQLFK_MAWB_ID: TStringField
      FieldName = 'FK_MAWB_ID'
      FixedChar = True
      Size = 15
    end
    object FindHawbLowDeletedSQLFK_CURRENCY: TStringField
      FieldName = 'FK_CURRENCY'
      Size = 3
    end
    object FindHawbLowDeletedSQLFK_COUNTRY_ORIGIN: TIntegerField
      FieldName = 'FK_COUNTRY_ORIGIN'
    end
    object FindHawbLowDeletedSQLDATE_REGISTERED: TDateTimeField
      FieldName = 'DATE_REGISTERED'
    end
    object FindHawbLowDeletedSQLCUSTOMER_NAME: TStringField
      FieldName = 'CUSTOMER_NAME'
      FixedChar = True
      Size = 40
    end
    object FindHawbLowDeletedSQLDESCRIPTION: TStringField
      FieldName = 'DESCRIPTION'
      Size = 150
    end
    object FindHawbLowDeletedSQLWEIGHT: TFloatField
      FieldName = 'WEIGHT'
    end
    object FindHawbLowDeletedSQLTOTAL_NUM_OF_PIECES: TIntegerField
      FieldName = 'TOTAL_NUM_OF_PIECES'
    end
    object FindHawbLowDeletedSQLNUMBER_OF_PARCELS: TIntegerField
      FieldName = 'NUMBER_OF_PARCELS'
    end
    object FindHawbLowDeletedSQLDISTRICT: TStringField
      FieldName = 'DISTRICT'
      FixedChar = True
      Size = 3
    end
    object FindHawbLowDeletedSQLTOTAL_CHARGES: TFloatField
      FieldName = 'TOTAL_CHARGES'
    end
    object FindHawbLowDeletedSQLNUM_OF_PIECES_ARRIVED: TIntegerField
      FieldName = 'NUM_OF_PIECES_ARRIVED'
    end
    object FindHawbLowDeletedSQLFK_CUSTOMER_CODE: TIntegerField
      FieldName = 'FK_CUSTOMER_CODE'
    end
  end
  object DeleteOneCDS: TIBCSQL
    Transaction = DeleteTrans
    Left = 1096
    Top = 169
  end
  object DeleteTrans: TIBCTransaction
    Left = 1168
    Top = 217
  end
  ...
  object FIndWaitingReasonSQL: TIBCQuery
    SQL.Strings = (
      'Select * From Clearance_Waiting_code where code_4= :XMLCode')
    ReadOnly = True
    Left = 696
    Top = 522
    ParamData = <
    ...
    object FIndWaitingReasonSQLCODE: TStringField
      FieldName = 'CODE'
      Required = True
      FixedChar = True
      Size = 3
    end
    object FIndWaitingReasonSQLDESCRIPTION: TStringField
      FieldName = 'DESCRIPTION'
      FixedChar = True
      Size = 40
    end
    object FIndWaitingReasonSQLCODE_4: TStringField
      FieldName = 'CODE_4'
      FixedChar = True
      Size = 4
    end
    object FIndWaitingReasonSQLDEFAULT_FOR_MEDIUM_VALUE: TStringField
      FieldName = 'DEFAULT_FOR_MEDIUM_VALUE'
      FixedChar = True
      Size = 1
    end
  end
  object RecentMawbSQL: TIBCQuery
    ...
    SQL.Strings = (
      ...
      'where '
      '  ma.mawb_id = :MawbId'
      '  and ma.date_arrived> :DateArrived')
    ReadOnly = True
    Left = 432
    Top = 658
    ParamData = <
    ...
    object RecentMawbSQLDATE_ARRIVED: TDateTimeField
      FieldName = 'DATE_ARRIVED'
    end
  end
  object FindDeliveryOrderChargeSQL: TIBCQuery
    SQLInsert.Strings = (
      'INSERT INTO OTHER_CHARGE'
      '  (AMOUNT)'
      'VALUES'
      '  (:AMOUNT)')
    SQLDelete.Strings = (
      'DELETE FROM OTHER_CHARGE'
      'WHERE'
      '  CODE = :Old_CODE')
    SQLUpdate.Strings = (
      'UPDATE OTHER_CHARGE'
      ...
      '  CODE = :Old_CODE')
    SQLRefresh.Strings = (
      'SELECT AMOUNT FROM OTHER_CHARGE'
      'WHERE'
      '  CODE = :CODE')
    SQLLock.Strings = (
      'SELECT NULL FROM OTHER_CHARGE'
      'WHERE'
      'CODE = :Old_CODE'
      'FOR UPDATE WITH LOCK')
    SQL.Strings = (
    ...
    object FindDeliveryOrderChargeSQLAMOUNT: TFloatField
      FieldName = 'AMOUNT'
    end
  end
  object FIndTariffSQL: TIBCQuery
    SQLInsert.Strings = (
      'INSERT INTO TARIFF'
      
        '  (CODE, GENERAL_DUTY_RATE, GENERAL_DUTY_TRL, GENERAL_DUTY_RATE_' +
        'QUANT, BASE_QUANTITY)'
      'VALUES'
      
        '  (:CODE, :GENERAL_DUTY_RATE, :GENERAL_DUTY_TRL, :GENERAL_DUTY_R' +
        'ATE_QUANT, :BASE_QUANTITY)')
    SQLDelete.Strings = (
      'DELETE FROM TARIFF'
      'WHERE'
      '  CODE = :Old_CODE')
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        '  CODE = :CODE, GENERAL_DUTY_RATE = :GENERAL_DUTY_RATE, GENERAL_' +
        'DUTY_TRL = :GENERAL_DUTY_TRL, GENERAL_DUTY_RATE_QUANT = :GENERAL' +
        '_DUTY_RATE_QUANT, BASE_QUANTITY = :BASE_QUANTITY'
      'WHERE'
      '  CODE = :Old_CODE')
    SQLRefresh.Strings = (
      
        'SELECT CODE, GENERAL_DUTY_RATE, GENERAL_DUTY_TRL, GENERAL_DUTY_R' +
        'ATE_QUANT, BASE_QUANTITY FROM TARIFF'
      'WHERE'
      '  CODE = :CODE')
    SQLLock.Strings = (
      'SELECT NULL FROM TARIFF'
      'WHERE'
      'CODE = :Old_CODE'
      'FOR UPDATE WITH LOCK')
    SQLRecCount.Strings = (
      'SELECT COUNT(*) FROM ('
      'SELECT 1 AS C  FROM TARIFF'
      ''
      ') q')
    SQL.Strings = (
      
        'Select  CODE, GENERAL_DUTY_RATE, GENERAL_DUTY_TRL, GENERAL_DUTY_' +
        'RATE_QUANT, BASE_QUANTITY  from Tariff where code= :Code')
    ReadOnly = True
    Left = 480
    Top = 418
    ParamData = <
    ...
    object FIndTariffSQLCODE: TStringField
      FieldName = 'CODE'
      Required = True
      Size = 17
    end
    object FIndTariffSQLGENERAL_DUTY_RATE: TFloatField
      FieldName = 'GENERAL_DUTY_RATE'
    end
    object FIndTariffSQLGENERAL_DUTY_TRL: TFloatField
      FieldName = 'GENERAL_DUTY_TRL'
    end
    object FIndTariffSQLGENERAL_DUTY_RATE_QUANT: TFloatField
      FieldName = 'GENERAL_DUTY_RATE_QUANT'
    end
    object FIndTariffSQLBASE_QUANTITY: TFloatField
  ...
  object HawbItemSQL: TIBCQuery
    ...
    SQLInsert.Strings = (
      'INSERT INTO AIRWAYBILL_ITEM'
        ...
        'AYBILL_SERIAL, TARIFF_CODE, AMOUNT, CURRENCY, CURRENCY_RATE, UNI' +
        'T_OF_MEASURE)'
      'VALUES'
      
        '  (:SEQUENCE, :WEIGHT, :PIECES, :DESCRIPTION, :SERIAL_NUMBER, :F' +
        'K_AIRWAYBILL_SERIAL, :TARIFF_CODE, :AMOUNT, :CURRENCY, :CURRENCY' +
        '_RATE, :UNIT_OF_MEASURE)')
    SQLDelete.Strings = (
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        ', AMOUNT = :AMOUNT, CURRENCY = :CURRENCY, CURRENCY_RATE = :CURRE' +
        'NCY_RATE, UNIT_OF_MEASURE = :UNIT_OF_MEASURE'
      'WHERE'
      '  SERIAL_NUMBER = :Old_SERIAL_NUMBER')
    SQLRefresh.Strings = (
      
        'SELECT SEQUENCE, WEIGHT, PIECES, DESCRIPTION, SERIAL_NUMBER, FK_' +
        'AIRWAYBILL_SERIAL, TARIFF_CODE, AMOUNT, CURRENCY, CURRENCY_RATE,' +
    ...
    UpdateTransaction = WriteTrans
    SQL.Strings = (
      'select * from AIRWAYBILL_item where Serial_number= :ItemSerial')
    Left = 1288
    Top = 624
    ParamData = <
      item
    ...
    object HawbItemSQLSEQUENCE: TIntegerField
      FieldName = 'SEQUENCE'
    end
    object HawbItemSQLWEIGHT: TFloatField
      FieldName = 'WEIGHT'
    end
    object HawbItemSQLPIECES: TIntegerField
      FieldName = 'PIECES'
    end
    ...
    object HawbItemSQLFK_AIRWAYBILL_SERIAL: TIntegerField
      FieldName = 'FK_AIRWAYBILL_SERIAL'
      Required = True
    end
    object HawbItemSQLTARIFF_CODE: TStringField
      FieldName = 'TARIFF_CODE'
      Size = 17
    end
    object HawbItemSQLAMOUNT: TFloatField
      FieldName = 'AMOUNT'
    end
    ...
    object HawbItemSQLUNIT_OF_MEASURE: TStringField
      FieldName = 'UNIT_OF_MEASURE'
      FixedChar = True
      Size = 9
    end
  end
  object FindDefaultVatSQL: TIBCQuery
    SQL.Strings = (
    ...
    Left = 880
    Top = 424
    object FindDefaultVatSQLCODE: TStringField
      FieldName = 'CODE'
      Required = True
      Size = 3
    end
    object FindDefaultVatSQLDESCRIPTION: TStringField
      FieldName = 'DESCRIPTION'
      Size = 30
    end
    object FindDefaultVatSQLRATE: TFloatField
      FieldName = 'RATE'
    end
    object FindDefaultVatSQLXML_CODE: TStringField
      FieldName = 'XML_CODE'
      FixedChar = True
      Size = 60
    end
  end
  object UpdateCustomer1CDS: TIBCSQL
  ...
  object FindChargeSQL: TIBCQuery
    SQLInsert.Strings = (
      'INSERT INTO OTHER_CHARGE'
      '  (AMOUNT)'
      'VALUES'
    ...
    object FindChargeSQLAMOUNT: TFloatField
      FieldName = 'AMOUNT'
    end
  end
  object SystemParametersSQL: TIBCQuery
    Connection = MainFormFRM.CabOutData
    SQL.Strings = (
      'select *  from System_Parameters where KEY_fIELD= :TheKey;')
    Left = 1216
    Top = 448
    ParamData = <
      item
    ...
    object SystemParametersSQLDATE_2: TDateTimeField
      FieldName = 'DATE_2'
    end
