...
// It has general data but also some values read from other hawb related tables
  ...
  public
    ...
    //    Function GetSystemValue(Const TheKey,ErrorMessage:String):String;
...
//********************************************
     ...
     CreateXMLNodeNew(FDoc,x1node,'IncotermCode','INCOTERM',xtext);
     CreateXMLNodeNew(FDoc,x1node,'ComplementaryCode','ComplementaryCode',xtext);
     CreateXMLNodeNew(FDoc,x1node,'ComplementOfInfo','ComplementOfInfo',xtext);
     ...
     CreateXMLNodeNew(FDoc,x1node,'Currency','Currency',xtext);
     CreateXMLNodeNew(FDoc,x1node,'TotalAmountInvoiced','TotalAmountInvoiced',xtext);
     CreateXMLNodeNew(FDoc,x1node,'ExchangeRate','ExchangeRate',xtext);
     CreateXMLNodeNew(FDoc,x1node,'NatureOfTransactionCode','NatureOfTransactionCode',xtext);

     x1node:=CreateXMLNodeNew(FDoc,TheRoot,'Msg515StatusRepresentative','',xnode);
     CreateXMLNodeNew(FDoc,x1node,'RepresentativeStatusCode','RepresentativeStatusCode',xtext);
      }
