...
type
  TL_AdditionalParametersFRM = class(TForm)
    ...
    procedure ParamItemSQLBeforePost(DataSet: TDataSet);
...
procedure TL_AdditionalParametersFRM.ParamItemSQLBeforePost(
  DataSet: TDataSet);
begin
if ParamGroupSQL.State=dsInsert then begin
        ParamGroupSQL.Post;
end;
