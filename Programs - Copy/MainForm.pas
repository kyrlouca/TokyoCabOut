...
uses
  ...
  wwclearpanel, Grids, Wwdbigrd, Wwdbgrid, fcLabel, Buttons, fcButton,
  fcImgBtn, fcShapeBtn, fcClearPanel, fcButtonGroup, IBC, DBAccess, Db,
...
uses  I_ReadHawbFile,I_readManifestFile, P_Deconsolidation,CreateOneXMLFile,
  ...
  ReadFIle, H_ScanAirwaybillNew, M_incoterms, M_serviceCode, M_Currency,
  l_FlightAirwaybillParameters;
...
begin
L_additionalParametersFRM.ShowModal;
end;
